...
class ClassDispatch{
    ...
    #Se existem parametros digitado pelo usuário
    ...
    #Verifica se o índice digitado pelo usuário é um ditetório
    ...
    #verifica se existe o arquivo requisitado, se não direcionar para o arquivo 404
