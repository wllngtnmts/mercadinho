...
function calculateWeight() {
    let quantityValue = parseFloat(quantityInput.value) || parseFloat(quantityInputEdit.value);
    let weightValue = parseFloat(weightInput.value) || parseFloat(weightInputEdit.value);
